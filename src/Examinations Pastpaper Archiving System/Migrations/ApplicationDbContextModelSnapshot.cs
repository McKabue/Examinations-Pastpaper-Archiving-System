...
using Examinations_Pastpaper_Archiving_System.Models;

namespace Examinations_Pastpaper_Archiving_System.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override void BuildModel(ModelBuilder builder)
        {
            ...
            builder.Entity("Examinations_Pastpaper_Archiving_System.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("Examinations_Pastpaper_Archiving_System.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
